...
public class TohInfixMinusOperator extends AbstractOperator {
  ...
  public EvaluationValue evaluate(
    ...
    } else if (leftOperand.isNumberValue() && rightOperand.isPercentageValue()) {
      return expression.convertValue(
          leftOperand
              .getNumberValue()
              .multiply(
                  (new BigDecimal(1)).add(rightOperand.getNumberValue().negate()),
